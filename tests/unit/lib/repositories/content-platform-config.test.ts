...
describe("content platform configuration", () => {
  ...
  it("parses valid administrator settings", () => {
    expect(
      parseContentPlatformConfig({
        ...
        CONTENT_RETRIEVAL_RERANK_ENABLED: "false",
        CONTENT_RETRIEVAL_RERANK_MODEL_ID: "cohere.rerank-v3-5:0",
        CONTENT_RETRIEVAL_CANDIDATE_LIMIT: "75",
        CONTENT_RETRIEVAL_NEIGHBOR_COUNT: "2",
        CONTENT_RETRIEVAL_CONTEXT_TOKENS: "8000",
        CONTENT_RETRIEVAL_RRF_K: "30",
        CONTENT_RETRIEVAL_MAX_PER_SOURCE: "5",
        CONTENT_VISUAL_EMBEDDING_MODEL_ID: "cohere.embed-v4:0",
        CONTENT_VISUAL_EMBEDDING_DIMENSIONS: "1536",
      ...
      retrievalCandidateLimit: 75,
      retrievalNeighborCount: 2,
      retrievalContextTokens: 8000,
      retrievalRrfK: 30,
      retrievalMaxPerSource: 5,
  ...
  it("falls back for malformed and out-of-bounds values", () => {
    const parsed = parseContentPlatformConfig({
      ...
      CONTENT_MAX_MEDIA_HOURS: "5",
      CONTENT_OCR_STRATEGY: "unknown",
      CONTENT_IMAGE_CAPTION_MODEL_ID: "anthropic.claude-haiku",
      CONTENT_RETRIEVAL_RERANK_ENABLED: "yes",
      CONTENT_RETRIEVAL_RERANK_MODEL_ID: "unsupported",
      CONTENT_RETRIEVAL_CANDIDATE_LIMIT: "101",
      CONTENT_RETRIEVAL_NEIGHBOR_COUNT: "4",
      CONTENT_RETRIEVAL_CONTEXT_TOKENS: "499",
      CONTENT_RETRIEVAL_RRF_K: "0",
      CONTENT_RETRIEVAL_MAX_PER_SOURCE: "21",
      CONTENT_VISUAL_EMBEDDING_MODEL_ID: "unsupported",
      CONTENT_VISUAL_EMBEDDING_DIMENSIONS: "1024",
