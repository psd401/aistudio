...
function defineVersionResolutionDeprecation927Suite99Part1() {
...
function defineVersionResolutionDeprecation927Suite99Part2() {it("dispatch emits deprecation telemetry for an authorized deprecated tool call", async () => {
      const { createLogger } = jest.requireMock("@/lib/logger") as {
        createLogger: () => { warn: jest.Mock }
      }
      const mockLogger = createLogger()
...
const defineVersionResolutionDeprecation927Suite99 = () => {
  defineVersionResolutionDeprecation927Suite99Part1()
  defineVersionResolutionDeprecation927Suite99Part2()
};

function defineToolCatalogSuite1Part1() {
  beforeEach(() => {
    dbRows = []
  })
...
function defineToolCatalogSuite1Part2() {it("respects an admin-disabled code tool (DB is_active=false)", async () => {
    dbRows = [
      {
        identifier: "decisions.search",
...
function defineToolCatalogSuite1Part3() {it("dispatch on the internal surface succeeds for an agent tool (#926)", async () => {
...
function defineToolCatalogSuite1Part4() {it("getRequiredScopes returns the surface-specific scope", async () => {
      const catalog = new ToolCatalog()
  ...
  describe("version resolution + deprecation (#927)", defineVersionResolutionDeprecation927Suite99)
...
function defineToolCatalogSuite1Part5() {describe("skill handlerRef dispatch (#925)", () => {
...
function defineToolCatalogSuite1Part6() {describe("version-pinned dispatch addressing (#927)", () => {
...
const defineToolCatalogSuite1 = () => {
  defineToolCatalogSuite1Part1()
  defineToolCatalogSuite1Part2()
  defineToolCatalogSuite1Part3()
  defineToolCatalogSuite1Part4()
  defineToolCatalogSuite1Part5()
  defineToolCatalogSuite1Part6()
};

describe("ToolCatalog", defineToolCatalogSuite1)
