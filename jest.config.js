...
const customJestConfig = {
  ...
  moduleNameMapper: {
    ...
    // Slot must precede the catch-all: mapping every @radix-ui/* specifier to
    // one file collapses them onto a single module-registry key, so the
    // per-package jest.mock factories in jest.setup.js overwrite one another
    // (see tests/mocks/radix-ui-slot.js).
