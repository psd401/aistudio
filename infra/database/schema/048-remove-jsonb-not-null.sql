-- Migration 048: Remove NOT NULL constraints from JSONB fields
...
-- instead of JSON strings when JSONB fields have .notNull() constraint.
--
-- Solution: Make columns NULLABLE (like nexus_conversations.metadata which works)
--
-- Related: Issue #599
