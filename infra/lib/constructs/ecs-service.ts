    ...
    return [
      ...
      new iam.PolicyStatement({
        ...
        actions: [
          ...
          's3:PutObject',
          's3:PutObjectTagging',
          // Versionless DeleteObject is used only to create a delete marker
          // when rolling back an uncommitted new workspace path. Historical
          // versions remain intact in the versioned bucket.
          's3:DeleteObject',
          's3:DeleteObjectVersion',
        ],
        resources: [`arn:aws:s3:::${agentWorkspaceBucketName}/*`],
