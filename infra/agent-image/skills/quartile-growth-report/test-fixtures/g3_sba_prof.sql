...
SELECT meas, ROUND(AVG(metv) FILTER (WHERE sectionid=274382),0) AS p1, COUNT(*) FILTER (WHERE sectionid=274382) AS n1, ROUND(AVG(metv) FILTER (WHERE sectionid=274392),0) AS p2, COUNT(*) FILTER (WHERE sectionid=274392) AS n2, ROUND(AVG(metv) FILTER (WHERE sectionid=274423),0) AS p3, COUNT(*) FILTER (WHERE sectionid=274423) AS n3, ROUND(AVG(metv) FILTER (WHERE in_sch),0) AS p_sch, COUNT(*) FILTER (WHERE in_sch) AS n_sch, ROUND(AVG(metv),0) AS p_dist, COUNT(*) AS n_dist
