...
const commonSettings = [
  ...
  { key: "CONTENT_REPOSITORY_CUTOVER_ENABLED", category: "Content Platform", description: "Cut Repository Manager over to canonical uploads and retrieval", isSecret: false },
  { key: "CONTENT_NEXUS_CUTOVER_ENABLED", category: "Content Platform", description: "Cut Nexus attachments over to canonical private repositories", isSecret: false },
  { key: "CONTENT_ASSISTANT_ARCHITECT_CUTOVER_ENABLED", category: "Content Platform", description: "Cut Assistant Architect document ingestion over to canonical repositories", isSecret: false },
  { key: "CONTENT_RETRIEVAL_SHADOW_ENABLED", category: "Content Platform", description: "Compare legacy and canonical Repository Manager retrieval", isSecret: false },
  { key: "CONTENT_LEGACY_RETIREMENT_ENABLED", category: "Content Platform", description: "Disable legacy content writes after verified migration and recovery window", isSecret: false },
  { key: "CONTENT_MIGRATION_RECOVERY_DAYS", category: "Content Platform", description: "Minimum rollback and quiet window before legacy retirement", isSecret: false },
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormDescription>
                    Uppercase letters, numbers, underscores (e.g., API_KEY, S3_BUCKET)
                  </FormDescription>
                  <FormMessage />
                </FormItem>
              )}
