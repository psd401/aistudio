...
export default async function AdminHubPage() {
  ...
  // Triage state lives in DynamoDB; unavailable locally. The action returns a
  // failed ActionState rather than throwing, so the hub degrades to the empty
  // quick-jump message instead of erroring.
  const triageResult = await getTriageSummaryList()
