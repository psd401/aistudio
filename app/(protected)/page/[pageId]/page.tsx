...
export default async function PublicPage({ params }: PageProps) {
  ...
  // Data fetching wrapped in try/catch — JSX return is outside
  type NavigationItem = typeof navigationItems.$inferSelect
  let pageItem: NavigationItem
  let childItems: NavigationItem[]
  ...
  try {
    ...
    const [foundItem] = await executeQuery(
      (db) => db.select()
    ...
    if (!foundItem || foundItem.type !== "page") {
      notFound()
    }
