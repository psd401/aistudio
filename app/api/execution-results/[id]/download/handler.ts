...
export async function downloadHandler(
  ...
  try {
    ...
    const markdown = generateMarkdown(executionResult, branding.orgName, branding.appName, branding.appUrl)
...
function generateMarkdown(result: ExecutionResultWithSchedule, orgName: string, appName: string, appUrl: string): string {
...
---
Generated by ${sanitizeMarkdownContent(appName)} - ${sanitizeMarkdownContent(orgName)}${appUrl ? `\nView online: ${sanitizeMarkdownContent(appUrl)}/execution-results/${result.id}` : ''}
`
