...
export async function downloadHandler(
  ...
  try {
    ...
    const markdown = generateMarkdown(executionResult, branding.orgName, branding.appName)
...
function generateMarkdown(result: ExecutionResultWithSchedule, orgName: string, appName: string): string {
...
---
Generated by ${sanitizeMarkdownContent(appName)} - ${sanitizeMarkdownContent(orgName)}
